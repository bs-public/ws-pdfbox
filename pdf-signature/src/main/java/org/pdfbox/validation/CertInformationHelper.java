...
public class CertInformationHelper {
  ...
  /**
   * Extracts authority information access extension values from the given data. The Data structure
   * has to be implemented as described in RFC 2459, 4.2.2.1.
   *
  ...
  /**
   * Gets the first CRL URL from given extension value. Structure has to be built as in 4.2.1.14 CRL
   * Distribution Points of RFC 2459.
   *
