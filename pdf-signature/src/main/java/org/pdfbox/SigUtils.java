...
public class SigUtils {
   ...
   *         dictionary is found but did not contain a /P entry, or if the value is outside the
   *         valid range.
   */
  ...
  /**
   * Log if the certificate is not valid for signature usage. Doing this anyway results in Adobe
   * Reader failing to validate the PDF.
   *
  ...
  public static TimeStampToken extractTimeStampTokenFromSignerInformation(
      SignerInformation signerInformation) throws CMSException, IOException, TSPException {
  ...
  /**
   * Verify the certificate chain up to the root, including OCSP or CRL. However this does not test
   * whether the root certificate is in a trusted list.<br>
   * <br>
